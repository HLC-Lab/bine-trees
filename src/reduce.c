...
int bine_reduce_small(const void *sendbuf, void *recvbuf, size_t count,
                      MPI_Datatype dt, MPI_Op op, int root, MPI_Comm comm)
{
  ...
  memcpy((char *)recvbuf, (char *)sendbuf, count*dtsize);
...
int bine_reduce_large(const void *sendbuf, void *recvbuf, size_t count,
                     MPI_Datatype dt, MPI_Op op, int root, MPI_Comm comm)
{
  ...
  memcpy(resbuf, (char *)sendbuf, count*dtsize);
